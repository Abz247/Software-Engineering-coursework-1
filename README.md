...
This project uses a Docker-based development environment to support a web application where users can buy and sell clothing products. The scaffolding provides all required services to develop and test a full-stack marketplace application using Node.js, MySQL, and phpMyAdmin.The purpose of this is to help students be able to buy and sell clothes with other students.
